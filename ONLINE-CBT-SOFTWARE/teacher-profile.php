...
<body>
    <div class="container rounded bg-white mt-5 mb-5">
        <form name="frmsave" method="post" id="frmsave" enctype="multipart/form-data" action="teacher-profile-db.php">
            <div class="row">
                ...
                <div class="col-md-5 border-right">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12"><label class="labels">Email ID</label><input type="text" class="form-control" placeholder="enter email id" name="emailid" value='<?php echo $_SESSION["active_user"];?>' readonly></div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6"><label class="labels">Expereince of teaching(in years)</label><input type="text" class="form-control" placeholder="2 yrs, 3 yrs, etc." value="" name="exp"></div>
                        <div class="col-md-6"><label class="labels">Additional Expereince</label><input type="text" class="form-control" value="" placeholder="eg:in any feild" name="add"></div>
                    </div>
